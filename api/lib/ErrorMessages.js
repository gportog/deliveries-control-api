...
module.exports.VALUE_MISMATCH_ERROR = function(parameter, expected, received) {
    return `Wrong value for parameter ${parameter}. Received ${received}, expected ${expected}`;
}
